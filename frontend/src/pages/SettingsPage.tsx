...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <section className="mt-6 border border-zinc-200 rounded-xl bg-white p-6">
        ...
        {notice && (
          <p className="mt-4 text-[15px] text-emerald-700">{notice}</p>
        )}

        {loaded && hasKey && (
          <div className="mt-4 flex items-center justify-between gap-4 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3">
          ...
          <label className="block">
            ...
            <div className="mt-1.5 flex gap-2">
              <input
                ...
                className="flex-1 h-11 px-3 rounded-lg border border-zinc-300 text-[15px] font-mono focus:border-zinc-500 outline-none"
              />
